...
<head>
    ...
    <title>Food Hub - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <footer class="footer"> © 2022 All rights reserved. Made with &#x1F49C; by <b><a href="https://www.youtube.com/channel/UC4_6-VSWBw_QHMyjrDDEvVQ"> GJK</a></b> Team. 
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
