...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="#categories">Categories<span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="Container text-center hero-text font-white">
                    <h1>Customized Food Ordering System</h1>
        ...
        <section class="featured-restaurants" id="categories">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Call us at: <a href="tel:+916380079773">+91 6380079773</a></h5></div>
